...
class _ExpenseEntryScreenState extends State<ExpenseEntryScreen> {
  ...
  final List<String> categories = ["Food", "Transportation", "Shopping", "Bills", "Entertainment", "Healthcare", "Education", "Other"];
  ...
  Future<void> _saveTransaction() async {
    ...
    try {
      final transaction = {
        ...
        'type': 'expense', // Changed to 'expense' instead of 'income'
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color(0xFFE91E63), // Pink background for expense (different from income purple)
      body: Column(
        children: [
          _buildTopSection(),
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          backgroundColor: Color(0xFFE91E63), // Pink color matching header
